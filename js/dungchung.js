...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">VDN Phone Store</a> Designed by
            <span style="color: #eee; font-weight: bold">Bai Tap Lon Nhom 3</span></p>
    </div>`);
}
...
function hienPopupChuyenKhoan() {
    document.getElementById('popupChuyenKhoan').style.display = 'flex';
}
function anPopupChuyenKhoan() {
    document.getElementById('popupChuyenKhoan').style.display = 'none';
}
